...
import com.cotato.weather.domain.place.service.WeatherService;
...
public class WeatherController {
    ...
    public ApiResponse<WeatherResponse> getWeatherByPlaceId(@PathVariable("placeId") Long placeId) {
        return ApiResponse.ok(weatherService.getWeather(placeId));
    }

//    @GetMapping("/test/weather")
//    public ApiResponse<WeatherResponse> testWeather() {
//        return ApiResponse.ok(weatherService.testWeather());
//    }
}
